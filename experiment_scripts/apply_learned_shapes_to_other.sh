...
./bpe/mnbpe --log \
    --apply "${lmd_bpe_path}/shape_vocab" --worker-number $worker_number \
...
cp "${lmd_bpe_path}/shape_vocab" "${base_path}/lmd--snd_ours_1.0"
...
./bpe/mnbpe --log \
    --apply "${snd_bpe_path}/shape_vocab" --worker-number $worker_number \
...
cp "${snd_bpe_path}/shape_vocab" "${base_path}/snd--lmd_ours_1.0"
